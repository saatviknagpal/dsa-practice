<h2><a href="https://leetcode.com/problems/sum-of-mutated-array-closest-to-target">1232. Sum of Mutated Array Closest to Target</a></h2><h3>Medium</h3><hr><p>Given an integer array <code>arr</code> and a target value <code>target</code>, return the integer <code>value</code> such that when we change all the integers larger than <code>value</code> in the given array to be equal to <code>value</code>, the sum of the array gets as close as possible (in absolute difference) to <code>target</code>.</p>
